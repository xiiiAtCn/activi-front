...
export const DEL_LAYER = 'del-layer'

export const MODIFY_LAYER = 'modify-layer'

//改变状态
export const CHANGE_PAGE_STATUS = 'CHANGE_PAGE_STATUS'
export const ADD_PAGE_STATUS = 'ADD_PAGE_STATUS'

export const ERASURE_DATA = 'ERASURE_DATA'
