...
export default {
    ...
    methods:{
        initData(){
          axios.get("/api/workCenter/workDeskCheck/listDefineCheck/"+this.$route.params.id)
               .then(data => {
        ...
        obtainData(){
            axios.get("/api/workCenter/workDesk/listDefine/"+this.$route.params.id)
             .then(response => {
            ...
            axios.get("/api/workCenter/workDesk/listData/"+this.$route.params.id)
               .then(response => {
                   console.log(response)
        ...
        newDeskCenter(){
             axios.post("/api/workCenter/workDesk/create/"+this.$route.params.id,this.newDeskModalMsg)
              .then(res=> {
                 if(res.status===200){
