                ...
                <div class="layout" v-if="leftMenu">
                    <Row type="flex" class="breadMenu out-use-menu-horizontal">
                        <i-col style="position:absolute;top:0;left:0">
                            <Breadcrumb class="out-use-menu-horizontal"
                                        separator="<b class='demo-breadcrumb-separator' style='color: #2d8cf0; font-size: 15px; font-weight: normal'></b>">
                        ...
                        <div style="position:absolute;top:0;right:0">
                            <img style="width: 60px; height: 60px; border-radius: 50%;margin-top:7px;float:left"
                                 src="../assets/img/head-portrait.jpg"/>
                            <div style="height:60px;float:right;margin:0 20px;margin-top:7px;">
                                ...
                                <div style="height:30px;line-height:30px;">
                                    ...
                                    <a href="javascript:;" class="designStyle" style="color:#2db7f5" @click="showDesign"
                                       v-if="designFlag">
                                        <Icon type="navicon-round"></Icon>
                                    </a>
                                    <a href="javascript:;" class="designStyle" style="color:#888888" @click="showDesign"
                                       v-if="!designFlag">
                                        <Icon type="navicon-round"></Icon>
                                    </a>
                                </div>
