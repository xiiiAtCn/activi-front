...
|序号|名称|类型|描述|来源|
|----|----|----|----|----|
|16|uploadAddress|computed|文件的上传路径|从define中获取，默认为'/api/file/picUpload'|
|17|deleteAddress|computed|文件的删除路径|从define中获取，默认为'/api/file/picDelete'|
...
|序号|名称|类型|描述|来源|
|----|----|----|----|----|
|16|uploadAddress|computed|图片的上传路径|从define中获取，默认为'/api/file/picUpload'|
|17|deleteAddress|computed|图片的删除路径|从define中获取，默认为'/api/file/picDelete'|
