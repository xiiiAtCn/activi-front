  ...
  <div class="s-nav">
    <Menu active-name="" theme="light" class="themeLight">
      <li class="layout-logo">
        <div class="relative">
          <img src="../assets/img/yushi-logo.png" alt="" class="yushi">
          <a href="http://www.sohu.com/" target="_blank" class="yushiCom">[ 主 页 ]</a>
          <a href="/layoutContent/04/workbench" class="deskStyle">[ 桌 面 ]</a>
        </div>
        <div class="clear"></div>
      </li>
      <div class="custom-menu">
        <Menu-item v-for="item in items" :name="item.code" :key="item.code" :id="item.code" class="menuBox">
